...
For a technical overview of the project structure, current implementation, and known limitations, see [PROJECT_OVERVIEW.md](https://github.com/jrcz-data-science-lab/moodle-plugin-quiz-generator/blob/main/PROJECT_OVERVIEW.md).

If you want to understand the development process or plan to build your own Moodle plugin, you can also review the following links or browse the full [Issues](https://github.com/jrcz-data-science-lab/moodle-plugin-quiz-generator/issues) page.
