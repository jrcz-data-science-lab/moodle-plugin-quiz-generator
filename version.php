...
defined('MOODLE_INTERNAL') || exit; // Security check. Stops the script if it is accessed directly. This ensures the file only runs inside Moodle.
...
$plugin->version = 2025112505; // Moodle uses this number to run upgrade steps. If the database structure changes, this number should be incremented.
